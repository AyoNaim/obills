...
export default function FintechDashboard() {
  ...
  const pullRotate = useTransform(pullDistance, [0, 120], [0, 360]);
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="fixed left-1/2 top-12 z-[100] pointer-events-none"
      >
        <div
          className={`p-3 rounded-full shadow-xl border ${
            isDarkMode
      ...
      {/* Main Draggable Content Container */}
      <motion.div
        drag="y"
        ...
        className={`min-h-screen pb-24 pt-safe px-6 touch-none ${
